...
def averageDistance(distFunc, sample, d):
...
if __name__ == '__main__':
    ...
    print("Used distance: {0}".format(euclidianDistance.__name__))

    sample = genSample(numsample, d)
    (average, maxd, mind) = averageDistance(euclidianDistance, sample, d)
